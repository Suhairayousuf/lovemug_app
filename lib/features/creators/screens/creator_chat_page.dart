        ...
        title: Row(
          children: [
            ...
            Column(
              ...
              children: [
                Text(widget.selectedUser.name, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold,color: Colors.white)),
                Text(widget.selectedUser.time, style: TextStyle(fontSize: 12, color: Colors.grey)),
              ],
            ),
          ],
        ),
